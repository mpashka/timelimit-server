...
```txt
https://timelimit.io/CreateFamilyWithParentSessionRequest#/definitions/PlaintextParentPassword
```
...
| :------------------ | :--------- | :------------- | :----------- | :---------------- | :-------------------- | :------------------ | :---------------------------------------------------------------------------------------------------------------------------- |
| Can be instantiated | No         | Unknown status | No           | Forbidden         | Forbidden             | none                | [CreateFamilyWithParentSessionRequest.schema.json\*](CreateFamilyWithParentSessionRequest.schema.json "open original schema") |
