...
export const isSignInByGoogleRequest: (value: unknown) => value is SignInByGoogleRequest = ajv.compile({
  "type": "object",
  "properties": {
    "idToken": {
      "type": "string"
